...
!(function () {
    ...
    var qrframe = [];
    var framask = [];
    var rlens = []; // Control values - width is based on version, last 4 are from table.
    var version;
    var width;
    var neccblk1;
    var neccblk2;
    ...
    var N2 = 3;
    var N3 = 40;
    var N4 = 10; // Using the table of the length of each run, calculate the amount of bad image
    ...
    function genframe(instring) {
        ...
        var i;
        var j;
        var m; // find the smallest version that fits the string
        t = instring.length;
        version = 0;
        do {
            version++;
